...
curl --user %JENKINSUSER% -o user.xsd %JENKINSURL%/user/bs/api/schema
...
curl --user %JENKINSUSER% -o myView.xsd "%JENKINSURL%/view/my view/api/schema"
...
rem jobs & builds
curl --user %JENKINSUSER% -o externalJob.xsd "%JENKINSURL%/job/External Job/api/schema"

curl --user %JENKINSUSER% -o folder.xsd "%JENKINSURL%/job/Folder/api/schema"

curl --user %JENKINSUSER% -o freeStyleProject.xsd "%JENKINSURL%/job/Freestyle Test Doc/api/schema"
curl --user %JENKINSUSER% -o freeStyleBuild.xsd "%JENKINSURL%/job/Freestyle Test Doc/2/api/schema"

curl --user %JENKINSUSER% -o organizationFolder.xsd %JENKINSURL%/job/GitHub/api/schema

curl --user %JENKINSUSER% -o workflowMultiBranchProject.xsd "%JENKINSURL%/job/Multibranch Pipeline/api/schema"
...
rem test result
curl --user %JENKINSUSER% -o testResult.xsd "%JENKINSURL%/job/Freestyle Test Doc/9/testReport/api/schema"
curl --user %JENKINSUSER% -o caseResult.xsd "%JENKINSURL%/job/Freestyle Test Doc/lastCompletedBuild/testReport/UT_Av2UnitTest/xml/_empty_/api/schema"
curl --user %JENKINSUSER% -o packageResult.xsd "%JENKINSURL%/job/Freestyle Test Doc/lastCompletedBuild/testReport/UT_Av2UnitTest/api/schema"
...
curl --user %JENKINSUSER% -o slaveComputer.xsd %JENKINSURL%/computer/b00014/api/schema
